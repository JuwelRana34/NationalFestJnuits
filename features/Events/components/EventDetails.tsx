...
import {
  AnimatedContainer,
  AnimatedItem,
} from "@/components/custom/AnimatedWrappers";
import MarkdownRenderer from "@/components/custom/MarkdownRenderer"; // পাথ ঠিক করে নেবেন
      ...
      <header className="bg-slate-900/50  ">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:block text-sm text-primary font-medium">
            ...
            Event ID: {id || segment?.id.split("_")[1]}
          </div>
        </div>
      </header>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <AnimatedItem className="space-y-4">
              ...
              <div className="prose max-w-none leading-relaxed text-slate-200">
                <MarkdownRenderer content={segment?.description || ""} />
              </div>
            </AnimatedItem>
                    ...
                    {segment?.prizeMoney && (
                      <div className="text-right">
                        <p className="text-xs font-medium text-slate-300 mb-1 flex items-center justify-end gap-1">
                          <Trophy className="w-3 h-3 text-secondary" /> Prize
                          Pool
                        </p>
                  ...
                  <div className="space-y-3">
                    ...
                    {occupancyPercentage >= 100 ? (
                      ...
                      <p className="text-xs text-secondary flex items-center gap-1 font-medium mt-2">
                        <AlertCircle className="w-3 h-3" /> Filling fast! Only{" "}
